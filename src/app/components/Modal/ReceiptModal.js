...
const ReceiptModal = ({
  ...
  const SaveReceipt = () => {
    axios
      .post(`https://dizzy-overcoat-moth.cyclic.app/receipt`, {
        ...receiptData,
    ...
    <div className="receipt-modal">
      ...
      >
        <div>
                ...
                <Row gutter={10}>
                  ...
                  <Col md={12}>
                    <Form.Item label="Period of Contract">
                      <Input
                        placeholder="Period of contract"
          ...
          <div>
            {/* <CustomButton handleClick={SaveReceipt} buttonName={'Next'} bgColor={'#527853'} color={'#F8F8F8'} /> */}
            <br />
            <Dropdown
              menu={{
                items,
            ...
            >
              <Button shape="circle" style={{ marginLeft: "90%" }}>
                <BsThreeDotsVertical />
              </Button>
            </Dropdown>
